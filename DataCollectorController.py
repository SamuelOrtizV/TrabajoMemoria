...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_fps', type=int, default=10, required=False, help='Máximo número de fotogramas por segundo')
    parser.add_argument('--full_screen', type=bool, default=False, required=False, help='Captura toda la pantalla o una ventana') 
    parser.add_argument('--data_path', type=str, default=data_path, required=False, help='Ruta donde se guardarán las imágenes')
