...
# Cargar el modelo preentrenado EfficientNetV2-S
model = models.efficientnet_v2_s(weights='IMAGENET1K_V1')
model.eval()  # Poner el modelo en modo evaluación

# Definir las transformaciones de imagen
transform = transforms.Compose([
    transforms.Resize((384, 384)),  # Redimensionar la imagen a 384x384
...
# Función para interpretar la salida del modelo
...
# Parámetros
image_path = r"C:\Users\PC\Pictures\meni.jfif"  # Cambiar a la ruta de tu imagen
...
output = predict(model, image_path, device)
